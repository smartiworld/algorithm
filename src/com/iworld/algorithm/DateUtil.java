...
public class DateUtil {
	...
	private static SimpleDateFormat dateSecondFormat = new SimpleDateFormat(DATE_SECOND_PATTERN);
	...
	public static String[] getDatePeriodDay(String sDate, String eDate)
			throws ParseException {
//		if (StringUtils.dateCompare(sDate, eDate)) {
//			return null;
//		}
		SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
		Calendar calendar = Calendar.getInstance();
...
//		if (StringUtils.checkEmpty(fromTime) != null && StringUtils.checkEmpty(toTime) != null) {
...
//	}
	...
	public static int getRentDay(Date startDate, Date endDate) {
        ...
        boolean add = periodTime - DateUtil.ONEDAY_MIL * day > DateUtil.ONEHOUR_MIL * 4;
		if (add) {
			day++;
		}
...
//        if (pickupDate == null || returnDate == null || PriceTypeEnum.LONG_RENT.getValue().equals(priceType)) {
//            return 0;
//        }
//        int hour = 0;
//        int second;
...
//		if (startDate == null || endDate == null || PriceTypeEnum.LONG_RENT.getValue().equals(priceType)) {
//			return false;
//		}
//
...
//	}
    ...
    public static Boolean getHalfdayFlag(Date startDate, Date endDate) {
        ...
        return periodTime - DateUtil.ONEDAY_MIL * day <= ONEHOUR_MIL * DefaultPriceValueConstant.HALFDAY_DEFAULT_HOUR;
    }
	...
	public static Date getEndTime4Calc(Date startDate, Date endDate) {
		...
		if (periodTime - DateUtil.ONEDAY_MIL * day <= ONEHOUR_MIL * DefaultPriceValueConstant.HALFDAY_DEFAULT_HOUR) {
			return dateAdd2Date(dateAdd2Date(startDate, TimeTypeEnum.DATE, (int)day),
					TimeTypeEnum.HOUR, DefaultPriceValueConstant.HALFDAY_DEFAULT_HOUR);
		} else {
	...
	public static boolean dateCompare(Date end, Date begin, Long seconds) {
		if (null == end) {
			throw new RuntimeException("比较时间时，end时间不能为null");
		}
		if (null == begin) {
			throw new RuntimeException("比较时间时，begin时间不能为null");
		}
	...
	public static boolean isBetweenDate(Date targetDate, Date startDate, Date endDate) {
		if (null == targetDate) {
			throw new RuntimeException("比较时间时，targetDate不能为null");
		}
		if (null == startDate) {
			throw new RuntimeException("比较时间时，startDate不能为null");
		}
		if (null == endDate) {
			throw new RuntimeException("比较时间时，endDate不能为null");
		}
