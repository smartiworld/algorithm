...
public class SortList {
    ...
    public ListNode sortList4(ListNode head) {
        ...
        pre.next = null;
        ListNode leftNode = sortList4(head);
        ListNode rightNode = sortList4(slow);
        return mergeTwoListAndOne(leftNode, rightNode);
    }
    
    private ListNode mergeTwoListAndOne(ListNode l1, ListNode l2) {
        ListNode result = new ListNode();
        ListNode cur = result;
        while (l1 != null && l2 != null) {
            if (l1.val <= l2.val) {
